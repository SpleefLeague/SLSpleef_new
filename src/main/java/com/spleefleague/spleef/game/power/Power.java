...
import com.spleefleague.spleef.game.power.effect.Effect;
import com.spleefleague.spleef.game.power.effect.EffectBuff;
import com.spleefleague.spleef.game.power.effect.EffectHeatBolts;
import com.spleefleague.spleef.game.power.effect.EffectRollerSpades;
...
public class Power extends DBEntity {
    ...
    private static InventoryMenu createActivePowerMenuItem(int slot) {
    ...
    public static InventoryMenu createMenu(int slot) {
        InventoryMenu menu = InventoryMenu.createMenu()
                .setTitle("Active Power: " + slotName[slot])
        ...
        menu.addStaticItem(createActivePowerMenuItem(slot), 4, 5);
    ...
    public static InventoryMenu createMenu() {
        ...
        menu.addStaticItem(createActivePowerMenuItem(0), 2, 5);
        menu.addStaticItem(createActivePowerMenuItem(1), 3, 5);
        menu.addStaticItem(createActivePowerMenuItem(2), 4, 5);
        menu.addStaticItem(createActivePowerMenuItem(3), 5, 5);
